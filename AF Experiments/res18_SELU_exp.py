...
# Recursively replace ReLU with SELU
...
replace_relu_to_selu(res18_model)
...
if __name__ == "__main__":
  ...
  res18_SELU_model, res18_SELU_epochs, res18_SELU_best_acc = train_model(res18_model, dataloaders_dict, criterion, res18_sgd, 100)

  # Write the epoch losses and accuracy into .txt files
  with open("res18_SELU_best_acc.txt", "w") as f:
      f.write(f"{res18_SELU_best_acc}")

  with open("res18_SELU_losses.txt", "w") as f:
      for item in res18_SELU_epochs[0]:
          f.write(f"{item}\n")

  with open("res18_SELU_accs.txt", "w") as f:
      for item in res18_SELU_epochs[1]:
          f.write(f"{item}\n")