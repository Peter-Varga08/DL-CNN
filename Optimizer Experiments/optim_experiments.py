...
if __name__ == "__main__":
  ...
  res18_SGD_model, res18_SGD_epochs, res18_SGD_best_acc = train_model(res18_model, dataloaders_dict, criterion, res18_sgd)

  # Train and evaluate using Adam
  res18_Adam_model, res18_Adam_epochs, res18_Adam_best_acc = train_model(res18_model, dataloaders_dict, criterion, res18_adam)

  # Train and evaluate using RMSProp
  res18_RMSProp_model, res18_RMSProp_epochs, res18_RMSProp_best_acc = train_model(res18_model, dataloaders_dict, criterion, res18_rmsprop)

  # Write the epoch losses and accuracy into .txt files
  # Adjust for different optimizers
  with open(f"res18_SGD_losses.txt", "w") as f:
    for item in res18_SGD_epochs[0]:
      f.write(f"{item}\n")

  with open(f"res18_SGD_accs.txt", "w") as f:
    for item in res18_SGD_epochs[1]:
      f.write(f"{item}\n")