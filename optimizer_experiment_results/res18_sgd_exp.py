...
if __name__ == "__main__":
  ...
  res18_SGD_model, res18_SGD_epochs, res18_SGD_best_acc = train_model(res18_model, dataloaders_dict, criterion, res18_sgd, 100)

  # Write the epoch losses and accuracy into .txt files
  with open("res18_SGD_best_acc.txt", "w") as f:
      f.write(f"{res18_SGD_best_acc}")

  with open("res18_SGD_losses.txt", "w") as f:
      for item in res18_SGD_epochs[0]:
          f.write(f"{item}\n")

  with open("res18_SGD_accs.txt", "w") as f:
